...
type Conf struct {
	...
	GoImage          string        `conf:"default:nafigat0r/go:1.24.4,short:g,help:Go docker image"`
	LinterImage      string        `conf:"default:nafigat0r/golangci-lint:2.1.6,short:l,help:Linter docker image"`
